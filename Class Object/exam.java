...
/*when a variable is final then its become a constant we can't change the value.
when class is final u can't inherit the class.
if function is final then it can't be over reden.*/
class student
{
	String name;
	double percent;
